/* =========================================================
   Studio Alvora — comportamento da página
   ========================================================= */
...
(function () {
  ...
  var CONFIG = {
    ...
    mensagemPadrao: "Olá! Vim pelo site do Studio Alvora e gostaria de agendar uma avaliação.",
  ...
  /* =======================================================
     ...
     Calculado no fuso de Brasília (UTC-3, sem horário
     de verão), não no relógio do visitante.
